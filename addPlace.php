...
<head>
    ...
    <title><?= env("TITLE") ?> | لوحة معلومات الأماكن</title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mx-auto">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="text-center">أضف مكانًا</h1>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="place_image" class="form-label">صور المكان</label>
                            ...
                            <div class="col-12">
                                <div class="form-group d-flex justify-content-end">
                                    <button type="submit" class="btn btn-success">إضافة مكان</button>
                                </div>
                            </div>
                        </div>
                    </form>
