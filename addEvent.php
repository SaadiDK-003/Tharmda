...
<head>
    ...
    <title><?= env("TITLE") ?> | لوحة معلومات الأحداث</title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mx-auto">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="text-center">إضافة حدث</h1>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="city" class="form-label">المدينة</label>
                                    <select name="city_id" id="city" class="form-select" required>
                                        <option value="" selected hidden>اختيار المدينة </option>
                                        <?= cityList() ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="event_image" class="form-label">صورة الحدث</label>
                            ...
                            <div class="col-12">
                                <div class="form-group d-flex justify-content-end">
                                    <button type="submit" class="btn btn-success">إضافة حدث</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <table id="event-table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">اسم الحدث</th>
                                <th class="text-center">تاريخ</th>
                                <th class="text-center">رابط الحجز</th>
                                <th class="text-center">صورة الحدث</th>
                        ...
                        <tbody>
                            <?php
                            $events_Q = $db->query("CALL `get_events`()");
                ...
                <form id="updateEventContent">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="upd_event_name" class="form-label">اسم الحدث</label>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="upd_date" class="form-label">تاريخ الحدث</label>
                                    <input type="date" name="date" id="upd_date" class="form-control" required>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="upd_booking_link" class="form-label">رابط الحجز</label>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <form id="updateEventImg" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="updEventImgModalLabel">Update صورة الحدث</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="form-group">
                                    <label for="upd_event_img" class="form-label">صورة الحدث</label>
