...
<head>
    ...
    <title><?= env("TITLE") ?> | لوحة معلومات الإقامة</title>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 mx-auto">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-12">
                                <h1 class="text-center">إضافة مكان إقامة</h1>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <select name="type" id="type" class="form-select" required>
                                        <option value="" selected hidden>اختيار النوع</option>
                                        <?= AccommodationTypes() ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    <label for="acc_image" class="form-label">صورة مكان الإقامة </label>
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                                    ...
                                    <code>كتابة الخدمات مفصولة بفواصل</code>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 mb-3">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="form-group d-flex justify-content-end">
                                    <button type="submit" class="btn btn-success">إضافة مكان إقامة</button>
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="row mt-5">
                <div class="col-12">
                    <table id="acc-table"
                        ...
                        <thead>
                            <tr>
                                <th class="text-center"> اسم المدينةName</th>
                                <th class="text-center">النوع</th>
                                <th class="text-center">الموقع</th>
                                <th class="text-center">الخدمات</th>
                                <th class="text-center">صور</th>
