            ...
            <div class="container my-3">
                  <div class="row">
                        <div class="col-12 text-center">
                              <h1>أماكن للزيارة في المملكة العربية السعودية</h1>
                              <p>نرحب بكم لزيارة بلدنا واستكشاف أجمل الأماكن في العالم.
                                    <strong>مكة</strong> و <strong>المدينة المنورة</strong>
                              </p>
                        </div>
                  </div>
            </div>
                  ...
                  <div class="modal-content">
                        <form id="addCommentForm">
                              <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="addCommentLabel">إضافة تقييم وتعليق</h1>
