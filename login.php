...
<head>
      ...
      <title><?= env("TITLE") ?> | تسجيل الدخول</title>
                              ...
                              <div class="row">
                                    ...
                                    <div class="col-12">
                                          <div class="form-group d-flex justify-content-between">
                                                <a href="./register.php" class="btn btn-primary">انشاء حساب</a>
                                                <button type="submit" name="submit"
                                                      class="btn btn-success">تسجيل الدخول</button>
                                          </div>
                                    </div>
                                    <div class="col-12 mt-5 text-center">
                                          <a href="./forgetPassword.php" class="btn btn-sm btn-secondary">هل نسيت كلمة المرور؟</a>
                                    </div>
                              </div>
                        </form>
                  </div>
