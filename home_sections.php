...
<section class="places">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">أماكن</h1>
            </div>
            <?php
...
<section class="accommodations">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">أماكن الإقامة</h1>
            </div>
            <?php
                        ...
                        <div class="content bg-white p-2 rounded">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="tel:<?= $acc_->phone ?>" data-bs-title="<?= $acc_->phone ?>"  data-bs-toggle="tooltip"
                                    class="btn btn-secondary"><i class="fas fa-phone"></i></a><!--here -->
                            </div>
                        </div>
                    </div>
                <?php endwhile;
...
<section class="events">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">الفعاليات</h1>
            </div>
            <?php
