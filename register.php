...
<head>
    ...
    <title><?= env("TITLE") ?> | انشاء حساب</title>
    ...
    <div class="container mx-auto vh-100 d-flex align-items-center justify-content-center">
        <div class="row">
            <div class="col-12 text-center mb-3">
                <h1><span class="text-primary"><?= env("TITLE") ?></span> <span class="text-secondary">|</span> انشاء حساب
                </h1>
            </div>
            <div class="col-12 col-md-3 mx-auto">
                ...
                <form action="" method="post">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-12 mb-3">
                            <div class="form-group">
                                <label for="role" class="form-label">اختيار نوع المستخدم</label>
                                <select name="role" id="role" class="form-select" required>
                                    <option value="" selected hidden>اختر الخيار</option>
                                    <option value="local">السكان المحليين</option>
                        ...
                        <div class="col-12">
                            <div class="form-group d-flex justify-content-between">
                                ...
                                <button type="submit" name="submit" class="btn btn-success">انشاء حساب</button>
                            </div>
                        </div>
                    </div>
                </form>
