...
<head>
    ...
    <title><?= env("TITLE") ?> | لوحة معلومات السائح</title>
    ...
    <main>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="buttons_wrapper position-relative text-center">
                        <a href="./my_comments.php" class="btn btn-secondary">تعليقاتي</a>
        ...
        <section class="places">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">الأماكن المفضلة</h1>
                    </div>
                    <?php
                    ...
                    if (mysqli_num_rows($places_Q) > 0) {
                                ...
                                <div class="content position-relative bg-white p-2 rounded">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="<?= $place_->location ?>" target="_blank"
                                            class="btn btn-primary w-75 flex-grow-1">الموقع</a>
                        ...
                        <div class="col-12">
                            <h1 class="text-center alert alert-info">لم يتم العثور على أي سجل</h1>
                        </div>
                    <?php }
                    $places_Q->close();
                    $db->next_result(); ?>
        ...
        <section class="accommodations">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">أماكن الإقامة المفضلة</h1>
                    </div>
                    <?php
                                ...
                                <div class="content bg-white p-2 rounded">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="<?= $acc_->location ?>" target="_blank"
                                            class="btn btn-primary w-75 flex-grow-1">الموقع</a>
                                            <a href="tel:<?= $acc_->phone ?>" data-bs-title="<?= $acc_->phone ?>"  data-bs-toggle="tooltip"
        ...
        <section class="events">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h1 class="bg-primary-custom text-white rounded ps-2 mb-3">الأحداث المفضلة</h1>
                    </div>
                    <?php
                                ...
                                <div class="content bg-white p-2 rounded">
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="<?= $event_->booking_link ?>" target="_blank"
                                            class="btn btn-primary w-75 flex-grow-1">رابط الحجز</a>
