...
<head>
    ...
    <title><?= env("TITLE") ?> | لوحة تحكم الاحداث المشرف</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="btn_wrapper d-flex justify-content-center align-items-center gap-2">
                        <a href="../addEvent.php" class="btn btn-primary">إضافة حدث</a>
                        <a href="../adminDashboard.php" class="btn btn-danger">الرجوعس</a>
                    </div>
                </div>
            </div>
            <div class="row mt-4">
                    ...
                    <table id="event-table"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">صور الحدث</th>
            ...
            <div class="modal-content">
                <form id="updateEventStatus">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="eventLabel">تحديث الحدث</h1>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select type="text" name="status" id="status" class="form-select" required>
                                        <option value="" selected hidden>اختر الحالة</option>
