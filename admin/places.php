...
<head>
    ...
    <title><?= env("TITLE") ?> |لوحة تحكم أماكن المشرف</title>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="btn_wrapper d-flex justify-content-center align-items-center gap-2">
                        <a href="../addPlace.php" class="btn btn-primary">إضافة أماكن</a>
            ...
            <div class="modal-content">
                <form id="updatePlaceStatus">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="placeLabel">تحديث المكان</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">حفظ التغيراتs</button>
                    </div>
                </form>
            </div>
        </div>
